		...
		if (!$error){
			...
			if (isset($_POST["from"]) && $_POST["from"] == "creerArticle"){
				...
				if (!verifyPresent("ARTICLES", "nom_article", $nom_article)){
					...
					$query = $db->prepare("INSERT INTO ARTICLES (nom_article, description_article, categorie_article, contenu_article) VALUES(:nom_article, :description_article, :categorie_article, :contenu_article)");
