...
<div class="navbar-default sidebar" role="navigation">
    ...
    <li>
        ...
        <ul class="nav nav-second-level">
            <li>
                <a href="!!!!!!!!!!!!!!!!!!!!!!!!!!!!!">Gérer les utilisateur</a>
            </li>
            <li>
    ...
    <li>
        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Équipes <span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li>
                <a href="!!!!!!!!!!!!!!!!!!!!!!!!!!!!!">Gérer les équipes</a>
            </li>
            <li>
                <a href="creerUtilisateur.php">Créer une équipe</a>
            </li>
        </ul>
    </li>
    ...
    <li>
        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Projets<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li>
        ...
        <div class="col-lg-4">
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> Modifications récentes par Équipe
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <ul class="timeline">
